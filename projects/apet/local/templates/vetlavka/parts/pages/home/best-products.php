...
$sections = [
  'suggestions' => [
    ...
    'filter' => ['>CATALOG_QUANTITY' => '0', '>PRICE' => 0, '>SHOW_COUNTER' => 11],
  ],
  'new' => [
    'name' => 'Новинки',
    'filter' => ['>=DATE_CREATE' => (new DateTime())->modify('-14 day')->format('d.m.Y H:i:s'), '>CATALOG_QUANTITY' => '0', '>PRICE' => 0],
  ],
];
 ...
 */
if ($discountProductsId = getDiscountProductsId(CATALOG_ID)) {
  $sections['stocks'] = [
    'name' => 'Акции',
    'filter' => ['=ID' => $discountProductsId],
  ];
}
?>

<div class="best home-section">
  <div class="container">
