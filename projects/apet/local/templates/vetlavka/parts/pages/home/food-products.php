...
$sections = [
  'akvariumistika_i_reptilii' => [
    ...
    'filter' => ['=SECTION_ID' => 66, '>CATALOG_QUANTITY' => '0', '>PRICE' => 0],
  ],
  'vetapteka' => [
    'name' => 'Ветаптека',
    'filter' => ['=SECTION_ID' => 80, '>CATALOG_QUANTITY' => '0', '>PRICE' => 0],
  ],
  'gryzuny_i_khorki' => [
    'name' => 'Грызуны и хорьки',
    'filter' => ['=SECTION_ID' => 92, '>CATALOG_QUANTITY' => '0', '>PRICE' => 0],
  ],
  'koshki' => [
    'name' => 'Кошки',
    'filter' => ['=SECTION_ID' => 103, '>CATALOG_QUANTITY' => '0', '>PRICE' => 0],
  ],
  'ptitsy' => [
    'name' => 'Птицы',
    'filter' => ['=SECTION_ID' => 125, '>CATALOG_QUANTITY' => '0', '>PRICE' => 0],
  ],
  'sobaki' => [
    'name' => 'Собаки',
    'filter' => ['=SECTION_ID' => 132, '>CATALOG_QUANTITY' => '0', '>PRICE' => 0],
  ],
];
?>

<div class="nutrion home-section home-section--grey">
  <div class="container">

    <div class="home-title title-row">
      <div class="title">Корма для животных</div>
    ...
    <div class="home-tabs js-tabs">
      <div class="tabs__actions blog__tabs">
        ...
        foreach ($sections as $key => $settings): ?>
          <button data-tab="<?= $key ?>"
                  class="tab-action tab-action--grey js-tab-action <? if ($isFirst) { ?> active <? } ?> ">
            <?= $settings['name'] ?>
          </button>
          <?
          $isFirst = false;
