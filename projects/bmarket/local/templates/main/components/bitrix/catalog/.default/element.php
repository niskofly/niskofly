...
$APPLICATION->SetPageProperty("title",str_replace('&quot;', '',$APPLICATION->GetTitle()));
$APPLICATION->SetPageProperty("keywords",str_replace('&quot;', '',$APPLICATION->GetProperty("keywords")));
$APPLICATION->SetPageProperty("description",str_replace('&quot;', '',$APPLICATION->GetProperty("description")));
...
if ($elementId > 0) {
    ...
    if (!empty($recommendedData)) {
        /**
         * todo: Разобраться с BigData на боевой лицензии
         */
