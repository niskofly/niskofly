...
$sections = [
  'new' => [
    'name' => 'Новинки',
    'filter' => ['>=DATE_CREATE' => (new DateTime())->modify('-14 day')->format('d.m.Y H:i:s')],
  ],
  'hit' => [
    'name' => 'Хит продаж',
    'filter' => ['PROPERTY_TEG_VALUE' => 'Хит продаж'],
  ],
  'suggestions' => [
    'name' => 'Советуем',
    'filter' => ['PROPERTY_TEG_VALUE' => 'Советуем'],
  ],
];
?>

<div class="section-best js-tabs container">
  ...
  <? foreach ($sections as $key => $settings): ?>
    <div data-tab-content="<?= $key ?>"
      ...
      $arParams = [
        ...
        "PRICE_CODE" => array('ruble'),
        "FILTER_PRICE_CODE" => array('ruble'),
