...
<div class="body">
  ...
  <div class="main_wrapper">
    <div class="hero_sec regularspanish" data-ix="show-bar">
      <div class="hero_cont regularspanish w-container">
        <h1 class="h1 hero"><?=$page->h1 ?></h1>
      <!--  <p class="hero_descr regularspanish">        -->
	    <?php 
	       // $before = str_replace('<p>','',$page->before_content);
	       // $before = str_replace('</p>','',$before);
	        echo Html::tag('div', Html::decode($page->before_content), ['class' => 'hero_descr regularspanish']);
	        
        ?>       <!-- </p> -->
        <a class="button hero regularspanish w-button" href="#Benefits"><?=Yii::t('app','Подробнее') ?>  &nbsp;<span class="arrow">5</span></a>
      </div>
    </div>
      ...
      <div class="benefits_cont w-container">
        <div class="w-row">
          <div class="benefits_row w-col w-col-4" data-ix="appear">
            <div class="div_icon"><img src="/images/page/icon_native.svg">
            </div>
            <h3 class="benefits_head"><?=$page->block2_1_head ?></h3>
            <div><?=$page->block2_1_desc ?></div>
          </div>
          <div class="benefits_row w-col w-col-4" data-ix="appear">
            <div class="div_icon"><img src="/images/page/icon_freeclass.svg">
            </div>
    ...
    <div class="programme_sec" id="Programme">
      <div class="programme-cont w-container">
        <div class="lead programme"><?=$page->block3_head ?></div><img class="image" data-ix="appear" sizes="(max-width: 767px) 92vw, (max-width: 991px) 728px, 891px" src="/images/page/levels_sp.png" srcset="/images/page/levels_sp-p-500.png 500w, /images/page/levels_sp-p-800.png 800w, /images/page/levels_sp-p-1080.png 1080w, /images/page/levels_sp-p-1600.png 1600w, /images/page/levels_sp.png 1778w" width="891"><a class="button green_oultine w-button" href="#Fees"><span class="icon_cta"></span><?=Yii::t('app','Стоимость курсов') ?></a>
      </div>
    </div>
    <div class="cc_sec">
        ...
        <div class="w-row" data-ix="appear">
          <div class="column w-col w-col-6">
            <div class="cc_wrapper w-clearfix">
              <div class="cc_left"><img src="/images/page/group_red_3.svg">
              </div>
              <div class="cc_right">
          ...
          <div class="column-2 w-col w-col-6">
            <div class="cc_wrapper right w-clearfix">
              <div class="cc_left"><img src="/images/page/individ_2.svg">
              </div>
              <div class="cc_right">
...
<!--
    ...
    <div class="allcourses_sec w-clearfix" data-ix="appear">
      <div class="allcourses-leftdiv regularspanish">
	      
	  		<?=$page->hrefs ?>


      </div>
      <div class="allcourses-rightdiv regularspanish"></div>
    </div>
  </div>
</div>
