...
<div class="section-food js-tabs">
  <div class="container">
    ...
    <div class="section-header">
      ...
      <a href="/" class="section-header__link">Перейти в каталог</a>
    </div>
    ...
    <div class="nav-subsection">
      ...
      foreach ($sections as $key => $settings): ?>
        <button data-tab="<?= $key ?>"
                class="btn btn--small btn--white nav-subsection__btn js-tab-action <? if ($isFirst) { ?>active<? } ?> ">
          <?= $settings['name'] ?>
        </button>
        <?
        $isFirst = false;
    ...
    <? foreach ($sections as $key => $settings): ?>
      <div data-tab-content="<?= $key ?>" class="tab js-tab<? if (array_key_first($sections) == $key): ?> active<? endif; ?>">
        <?
        global $arrFilter;
