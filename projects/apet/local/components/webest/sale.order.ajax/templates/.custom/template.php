...
if (strlen($request->get('ORDER_ID')) > 0) {
  ...
  ?>
    ...
    <style>
        .form-cart__payer .form-cart__label {
            display: none;
        }
        .form-cart__payer .input-groups {
            display: none;
        }
    </style>
  ...
  <div class="cart-columns js-order-registration">
    <div class="cart-columns__left">
      <div class="cart-columns__wrapper">
        <?
        Main\UI\Extension::load('phone_auth');

        $hideDelivery = empty($arResult['DELIVERY']);
        $firstStore = current($arResult["STORE_LIST"]);
        $firstStoreId = $firstStore ? $firstStore['ID'] : null;
        $buyerStore = $arResult['BUYER_STORE'] ?: $firstStoreId;
        $buyerStoreAddress = $arResult["STORE_LIST"][$buyerStore]['ADDRESS']
        ?>
        <form action="<?= POST_FORM_ACTION_URI ?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form"
          ...
          <input type="hidden"
                 ...
                 value="N">
          <input type="hidden"
                 name="DELIVERY_ID_OLD"
                 value="">
          <input type="hidden"
                 name="SELECT_PICKUP_ADDRESS"
                 value="<?= $buyerStoreAddress ?>">

          <!-- todo: Удалить при верстке -->
          <div id="bx-soa-order" style="opacity: 0">

            <!--	MAIN BLOCK	-->
            <div class="bx-soa cart-main">
              ...
              <div id="bx-soa-total-mobile" class="cart-main__total-mobile"></div>

              <? if ($arParams['BASKET_POSITION'] === 'before'): ?>
                <!--	BASKET ITEMS BLOCK	-->
                <div id="bx-soa-basket" data-visited="false"
                     class="cart-main__basket bx-soa-section bx-active">
                  <div class="bx-soa-section-title-container">
                    <h2 class="bx-soa-section-title">
              ...
              <div id="bx-soa-region" data-visited="false"
                   class="bx-soa-section bx-active cart-main__region">
                <div class="bx-soa-section-title-container cart-main__head">
                  <h2 class="bx-soa-section-title cart-main__region-title">
                    <span class="cart-main__region-title-round">
                      1
                    </span>
                    <span class="bx-soa-section-title-count cart-main__region-title-text">
                ...
                <div class="bx-soa-section-content cart-main__region-content"></div>
              </div>
              ...
              <? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
                ...
                <div id="bx-soa-delivery"
                     data-visited="false"
                     class="bx-soa-section bx-active cart-main__delivery" <?= ($hideDelivery ? 'style="display:none"' : '') ?>>
                  <div class="bx-soa-section-title-container cart-main__head">
                    <h2 class="bx-soa-section-title cart-main__delivery-title">
                      <span class="cart-main__region-title-round">
                      2
                    </span>
                      <span class="bx-soa-section-title-count cart-main__delivery-title-text">
              ...
              <? else: ?>
                ...
                <div id="bx-soa-delivery" data-visited="false"
                  ...
                  <div class="bx-soa-section-content cart-main__delivery-content"></div>
                </div>
                <!--	PICKUP BLOCK	-->
                <div id="bx-soa-pickup" data-visited="false" class="bx-soa-section cart-main__delivery cart-main__delivery--pickup"
                     style="display:none">
                  <div class="bx-soa-section-title-container cart-main__head">
                    <h2 class="cart-main__delivery-title-text bx-soa-section-title">
                      <span class="bx-soa-section-title-count"></span>
                    </h2>
                    <div class="text-right btn"> Изменить пункт выдачи
                      <a href="" class="bx-soa-editstep"><?= $arParams['MESS_EDIT'] ?></a>
                    </div>
                  </div>
                  <div class="bx-soa-section-content"></div>
                ...
                <div id="bx-soa-paysystem" data-visited="false"
                     class="bx-soa-section bx-active cart-main__paysystem">
                  <div class="bx-soa-section-title-container cart-main__head">
                    <h2 class="bx-soa-section-title cart-main__paysystem-title">
                      <span class="cart-main__paysystem-title-round">
                       3
                      </span>
                      <span class="bx-soa-section-title-count cart-main__paysystem-title-text">
                  ...
                  <div class="bx-soa-section-content cart-main__paysystem-content"></div>
                </div>
              <? endif ?>

              <!--	BUYER PROPS BLOCK	-->
              <div id="bx-soa-properties" data-visited="false"
                   class="bx-soa-section bx-active cart-main__properties">
                <div class="bx-soa-section-title-container cart-main__head">
                  <h2 class="bx-soa-section-title cart-main__properties-title">
                    <span class="cart-main__properties-title-round">
                       4
                      </span>
                    <span class="bx-soa-section-title-count cart-main__properties-title-text">
                ...
                <div class="bx-soa-section-content cart-main__properties-content"></div>
              </div>
              ...
              <div class="cart-total">
                <div class="cart-total__sum">
                  <span class='cart-total__sum-text'>Итоговая сумма:</span>
                  <span class="cart-total__sum-value js-order-footer-total-sum">
                    <?= $arResult['ORDER_TOTAL_PRICE_FORMATED'] ?>
                  </span>
                </div>

                <div class="cart-total__actions">
                  <div class="form-cart__terms cart-total__terms">
                    <label class='checkbox cart-total__checkbox'>
                      <input
                        type="checkbox"
                        checked
                        value="value"
                        name="checkbox__input cart-total__checkbox-input js-check-box-politic">
                      <span class='checkbox__indicator cart-total__checkbox-indicator'>
												<svg class='icon icon-check'>
													<use xlink:href='#check'></use>
												</svg>
											</span>
                      <span class='checkbox__description cart-total__checkbox-description'>
												<span class='cart-total__checkbox-description-text'>Согласен на обработку</span>
												<a
                          class='cart-total__checkbox-description-link'
                          href="/politic/"
                  ...
                  <button
                    class="cart-total__order-save-btn js-order-save"
                    type="button">
                    Оформить заказ
                  </button>
                </div>
    ...
    <div class="cart-columns__right">
      <div class="cart-columns__wrapper cart-columns__wrapper--order">
        <div class="cart-order">
          <div class="cart-order__header">
            <div class="cart-order__title title title--second">Корзина</div>
            <div class="cart-order__span"><?= count($arResult["BASKET_ITEMS"]) ?></div>
          </div>
          <div class="cart-order__body">
            <? foreach ($arResult["BASKET_ITEMS"] as $basketItem): ?>
            <? $discountPrecent = $basketItem['DISCOUNT_PRICE_PERCENT_FORMATED']; ?>
            <div class="cart-order__item <?= $basketItem['DISCOUNT_PRICE'] ? 'order-card--discount' : '' ?>">
              <div class="order-card js-manage-basket-item">
                <div class="order-card__pic">
                  <img src="<?= $basketItem['PREVIEW_PICTURE_SRC'] ?>"
                       alt="<?= $basketItem['NAME'] ?>"/></div>
                <div class="order-card__content">
                  <div class="order-card__title"><?= $basketItem['NAME'] ?></div>
                  <div class="order-card__manufacturer">
                    <?= getNameElementById($basketItem['PROPERTY_BRAND_VALUE']) ?></div>

                  <div class="order-card__row">
                    <div class="order-card__prices js-product-cart-prices-<?= $basketItem['ID'] ?>"
                    ">
                    <!-- Цена товара -->
                    <div class="order-card__price">
                      <?= $basketItem['PRICE_FORMATED'] ?></div>
                    <!-- Цена товара со скидкой -->
                    <? if ($basketItem['PRICE'] != $basketItem['BASE_PRICE']): ?>
                      <div class="order-card__old-price">
                        <?= $basketItem['BASE_PRICE_FORMATED'] ?></div>
                    <? endif; ?>
                  </div>

                  <!-- Изменение кол-во покупаемых товаров -->
                  <form action="/api/catalog/controller-addToCart.php"
                        class="js-manage-basket-item-update-form">
                    <input type="hidden" name="BASKET_ITEM_ID"
                           value="<?= $basketItem['ID'] ?>">
                    <input type="hidden" name="ACTION" value="UPDATE_BASKET_ITEM">
                    <input type="hidden"
                           name="COUNT_ELEMENT"
                           value="<?= CCatalogProduct::GetByID($basketItem['PRODUCT_ID'])['QUANTITY'] ?>">
                    <input type="hidden" name="QUANTITY"
                           value="<?= $basketItem['QUANTITY'] ?>">

                    <div class="order-card__counter">
                      <div class="counter counter--rounded">
                        <button type="button"
                                class="counter__button counter__button-minus js-manage-basket-item-reduce"></button>
                        <div
                          class="counter__label js-manage-basket-item-quantity-display"><?= $basketItem['QUANTITY'] ?></div>
                        <button type="button"
                                class="counter__button counter__button-plus js-manage-basket-item-increase"></button>
                      </div>
                    </div>
                  </form>
                </div>
              ...
              <form action="/api/catalog/controller-addToCart.php"
                    class="js-manage-basket-item-remove">
                <input type="hidden" name="BASKET_ITEM_ID"
                       value="<?= $basketItem['ID'] ?>">
                <input type="hidden" name="ACTION" value="REMOVE_BASKET_ITEM">
                <button type="submit" class="order-card__delete">
        ...
        <div class="cart-order__footer">
          <div class="cart-order__sum">
            <div class="cart-order__sum-description">Сумма заказа</div>
            <div class="cart-order__sum-price js-order-total-basket"><?= $arResult["PRICE_WITHOUT_DISCOUNT"] ?></div>
          </div>
          <div class="cart-order__sum">
            <div class="cart-order__sum-description">Скидка:</div>
            <div class="cart-order__sum-price js-order-total-sale"><?= $arResult["DISCOUNT_PRICE_FORMATED"] ?></div>
          </div>
          <div class="cart-order__sum">
            <div class="cart-order__sum-description">Доставка</div>
            <div class="cart-order__sum-price js-order-total-delivery"><?= $arResult["DELIVERY_PRICE_FORMATED"] ?></div>
          </div>
          <div class="cart-order__sum cart-order__sum--total">
            <div class="cart-order__sum-description">Итоговая сумма</div>
            <div class="cart-order__sum-price js-order-total-sum"><?= $arResult['ORDER_TOTAL_PRICE_FORMATED'] ?></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <script>
    window.__COUPON_LIST__ = '<?=json_encode($arResult["JS_DATA"]["COUPON_LIST"])?>';
  </script>

  <script>
    BX.message(<?=CUtil::PhpToJSObject($messages)?>);
    window.OrderAjax = BX.Sale.OrderAjaxComponent.init({
