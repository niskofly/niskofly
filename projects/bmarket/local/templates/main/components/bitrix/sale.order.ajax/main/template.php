...
if ($request->get('ORDER_ID') <> '') {
    ...
    <form action="<?= POST_FORM_ACTION_URI ?>" method="POST"
          name="ORDER_FORM"
          class="form form--order order__main" id="bx-soa-order-form" enctype="multipart/form-data">
        <?
        ...
        <div id="bx-soa-order" class="row" style="opacity: 0">
            ...
            <div class="col-lg-8 col-md-7 bx-soa">
                ...
                <? if ($arParams['BASKET_POSITION'] === 'before'): ?>
                    ...
                    <div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
                        <div
                            ...
                            <div><a href="javascript:void(0)" class="bx-soa-editstep"><?= $arParams['MESS_EDIT'] ?></a>
                            </div>
                        </div>
                        <div class="bx-soa-section-content"></div>
                    </div>
                ...
                <!--	REGION BLOCK	-->
                <div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active order-step">
                    <div class="bx-soa-section-title-container order-step__header">
                        <div class="bx-soa-section-title title title--medium" data-entity="section-title">
                ...
                <div id="bx-soa-delivery" data-visited="false"
                     class="bx-soa-section bx-active order-step" <?= ($hideDelivery ? 'style="display:none"' : '') ?>>
                    <div class="bx-soa-section-title-container order-step__header">
                        <div class="bx-soa-section-title title title--medium" data-entity="section-title">
                ...
                <!--	PICKUP BLOCK	-->
                <div id="bx-soa-pickup" data-visited="false" class="bx-soa-section order-step" style="display:none">
                    <div class="bx-soa-section-title-container order-step__header">
                        <div class="bx-soa-section-title title title--medium" data-entity="section-title">
                            <span class="bx-soa-section-title-count"></span>
                        </div>
                ...
                <!--	PAY SYSTEMS BLOCK	-->
                <div id="bx-soa-paysystem" data-visited="false" class="bx-soa-section bx-active order-step">
                    <div class="bx-soa-section-title-container order-step__header">
                        <div class="bx-soa-section-title title title--medium" data-entity="section-title">
                    ...
                    <div class="bx-soa-section-content input-groups"></div>
                </div>

                <!--	BUYER PROPS BLOCK	-->
                <div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active order-step">
                    <div class="bx-soa-section-title-container order-step__header">
                        <div class="bx-soa-section-title title title--medium" data-entity="section-title">
                    ...
                    <div class="order-step__total">
                        <div class="order-step__price">
                            <div class="order-step__price-label">Итого:</div>
                            <div
                                class="order-step__price-value js-order-total-sum"><?= $arResult['ORDER_TOTAL_PRICE'] ?></div>
                        </div>
                        <div class="order-step__total-actions">
                            <label class="checkbox checkbox--privacy order-step__total-privacy">
                                <input type="checkbox" class="js-order-privacy-input" name="privacy" value="Y" checked>
                            ...
                            <button type="button" class="btn js-order-submit-btn" data-save-button="true">
                                Подтвердить заказ
                            </button>
                        </div>
                    </div>
                ...
                <? if ($arParams['BASKET_POSITION'] === 'after'): ?>
                    ...
                    <div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
                        <div
                            ...
                            <div class="bx-soa-section-title" data-entity="section-title">
                                <span
                                    class="bx-soa-section-title-count"></span><?= $arParams['MESS_BASKET_BLOCK_NAME'] ?>
                            </div>
                            <div><a href="javascript:void(0)" class="bx-soa-editstep"><?= $arParams['MESS_EDIT'] ?></a>
                            </div>
                        </div>
                ...
                <!--	ORDER SAVE BLOCK	-->
                <div id="bx-soa-orderSave" style="display: none !important">
                    <div class="checkbox">
                        <?
    ...
    <div class="order__sidebar">
        <div class="order__sidebar-section">
            ...
            <div class="order-calculate order-calculate--ordering">
                <div class="order-calculate__list">
                    <div class="order-calculate__item-basket js-order-basket-products">
                    </div>
                    <div class="order-calculate__item order-calculate__item--discount">
                        <div class="order-calculate__item-label">Скидка на товары</div>
                        <div
                            class="order-calculate__item-value js-order-total-sale"><?= $arResult["DISCOUNT_PRICE_FORMATED"] ?></div>
                    </div>
                    <div class="order-calculate__item order-calculate__item--delivery">
                        <div class="order-calculate__item-label">Доставка</div>
                        <div
                            class="order-calculate__item-value js-order-total-delivery"><?= $arResult["DELIVERY_PRICE_FORMATED"] ?></div>
                    </div>
                    <div class="order-calculate__item order-calculate__item--delivery">
                        <div class="order-calculate__item-label">Бонусов на счет</div>
                        <div
                            class="order-calculate__item-value">
                            <?= round($arResult['ORDER_PRICE'] / 100 * BONUSES_PERCENT) ?>₽
                        </div>
                    </div>
                </div>
                <div class="order-calculate__total">
                    ...
                    <div
                        class="order-calculate__total-value js-order-total-sum"><?= $arResult['ORDER_TOTAL_PRICE'] ?></div>
                </div>
    ...
    <script>
        ...
        VkSendProductEvent(window.vkPriceId, 'init_checkout', {
            currency_code: 'RUB',
            business_value: '<?=$arResult['JS_DATA']['TOTAL']['ORDER_TOTAL_PRICE']?>',
            products: [basketProducts],
        });

        document.addEventListener("DOMContentLoaded", function () {
            fbq('track', 'InitiateCheckout', {
                value: '<?=$arResult['JS_DATA']['TOTAL']['ORDER_TOTAL_PRICE']?>',
                currency: 'RUB',
                contents: basketProducts,
            ...
            _tmr.push({
                ...
                totalvalue: '<?=$arResult['JS_DATA']['TOTAL']['ORDER_TOTAL_PRICE']?>'
            })

            window.metrics.reachGoal('clickOrder');
        });
    </script>
<? } ?>
