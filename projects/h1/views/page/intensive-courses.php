...
<div class="body">
    ...
    <div class="main_wrapper">
        <div style="height: auto;padding-bottom: 40px;" class="hero_sec regularenglish" data-ix="show-bar">
            <div class="hero_cont regularenglish w-container">
                <h1 class="h1 hero regularenglish"><?=$page->h1 ?></h1>
                <?php
                $before = '<p class="hero_descr regularenglish">';
                $before .= $page->before_content;
                $before .= '</p>';
                // echo $before;

                echo Html::tag('div', Html::decode($page->before_content), ['class' => 'hero_descr regularenglish', 'style' => 'color:black']);
                // $before = str_replace('</p>','',$before);

                ?>
                <!--        <p class="hero_descr regularenglish"> <?php //echo $before; ?> </p>  -->
                <a class="button hero regulararabic w-button" href="<?=Url::toRoute(['tests/1'])?>"><?=Yii::t('app','Пройти бесплатный тест ') ?> &nbsp;<span class="arrow">5</span></a>
            </div>
        </div>
            ...
            <div class="benefits_cont w-container">
                <div class="w-row">
                    <div class="benefits_row w-col w-col-4" data-ix="appear">
                        <div class="div_icon"><img src="/images/page/native_icon.svg">
                        </div>
                        <h3 class="benefits_head"><?=$page->block2_1_head ?></h3>
                        <div><?=$page->block2_1_desc ?></div>
                    </div>
                    <div class="benefits_row w-col w-col-4" data-ix="appear">
                        <div class="div_icon"><img src="/images/page/class_icon.svg">
                        </div>
        ...
        <div class="programme_sec" id="Programme">
            <div class="programme-cont w-container">
                <div class="lead programme regularenglish"><?=$page->block3_head ?></div><img class="image" data-ix="appear" sizes="(max-width: 767px) 92vw, (max-width: 991px) 728px, 891px" src="/images/page/levels_eng.png" srcset="/images/page/levels_eng-p-500.png 500w, /images/page/levels_eng-p-800.png 800w, /images/page/levels_eng-p-1080.png 1080w, /images/page/levels_eng-p-1600.png 1600w, /images/page/levels_eng.png 1774w" width="891"><a class="blue_outline button w-button" href="#Fees"><span class="icon_cta"></span> <?=Yii::t('app','Стоимость курсов') ?></a>
            </div>
        </div>
        <div class="cc_sec">
                ...
                <div class="w-row" data-ix="appear">
                    <div class="column w-col w-col-6">
                        <div class="cc_wrapper w-clearfix">
                            <div class="cc_left"><img src="/images/page/Group_3.svg">
                            </div>
                            <div class="cc_right">
                    ...
                    <div class="column-2 w-col w-col-6">
                        <div class="cc_wrapper right w-clearfix">
                            <div class="cc_left"><img src="/images/page/Individ_1.svg">
                            </div>
                            <div class="cc_right">
                    ...
                    <div class="w-slider-mask">
                        <div class="price toefl_slide w-slide">
                            <div class="price_div price_div_left slider" data-ix="price-left">
                                ...
                                <div class="price_cost_descr"><?=isset($data[0]) ? $data[0]->desc_price_all : '' ?></div><a class="button course w-button" data-ix="show-modal-join" href="#"><?=Yii::t('app','Выберите курс')?></a>
                            </div>
                        </div>
                        <div class="price toefl_slide w-slide">
                ...
                <div class="fees_row_wr w-row">
                    <div class="fees_row w-col w-col-4 w-col-medium-4 w-col-small-4" data-ix="show-modal-join">
                        <div class="price_div price_div_left w-preserve-3d" data-ix="price-left">
                            ...
                            <div class="price_cost_descr"><?=isset($data[0]) ? $data[0]->desc_price_all : '' ?></div><a class="button course w-button" href="#"><?=Yii::t('app','Выберите курс')?></a>
                        </div>
                    </div>
                    <div class="fees_row w-col w-col-4 w-col-medium-4 w-col-small-4" data-ix="show-modal-join">
                        <div class="price_div price_middle_div">
        ...
        <div class="allcourses_sec w-clearfix" data-ix="appear">
            <div class="allcourses-leftdiv regularenglish" style="color: black">

                <?=$page->hrefs ?>

            </div>
            <div class="allcourses-rightdiv regularenglish"></div>
        </div>
    </div>
</div>
