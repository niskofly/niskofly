...
<div class="body">
 ...
 <?= SimpleCouponFormWidget::widget(['type'=>'2','course'=>$page->name]) ?>
  ...
  <div class="main_wrapper">
    <div class="hero_sec onlane_english" data-ix="show-bar">
      <div class="hero_cont regularenglish w-container">
        ...
        <?php
	        ...
	        echo Html::tag('div', Html::decode($page->before_content), ['class' => 'hero_descr regularenglish']);
	       // $before = str_replace('</p>','',$before);

        ?>
<!--        <p class="hero_desc.hero_sec.regularenglishr regularenglish"> <?php //echo $before; ?> </p>  -->
...
-->
    ...
    <div class="allcourses_sec w-clearfix" data-ix="appear">
      <div class="allcourses-leftdiv regularenglish">
