...
$postData = array(
    ...
    'token_name' => Yii::$app->security->generateRandomString()
);
            ...
            <tr>
                <td colspan="2" class="text-right">
                    ...
                    <form action="<?= $gatewayUrl ?>" method='post' name='frm'>
                        ...
                        ?>
                        <div class="warning-recurse-pay">
                            <?= Yii::t('app', 'warning-recurse-pay') ?>
                        </div>
                        ...
                        <input id="i_hereby_send" type="submit" value="<?= Yii::t('app', 'Перейти к оплате') ?>" class="btn btn-primary">
                    </form>
