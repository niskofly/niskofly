...
if (!empty($arResult['ITEMS']))
{
	...
	?>
	<div class="lk-subscriptions bx_item_list_you_looked_horizontal col<?=$arParams['LINE_ELEMENT_COUNT'];?>">
...
<!--		</div>-->
	...
	<?if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS'])) // Simple Product
	{
		...
		<div class="bx_catalog_item_controls">
			...
			<div>
				<a id="<?=$arItemIDs['SUBSCRIBE_DELETE_LINK'];?>" class="btn-link link" href="javascript:void(0)">
